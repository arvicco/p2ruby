...
begin
  // выводим сообщение, за какое время была поставлена заявка
  if assigned(Form1) then Form1.log('Заявка обработана биржей за %d милисекунд', [Form1.fPreciseTime.msecs - eventParam])
end;
